...
export const translations: Translations = {
  nl: {
    ...
    customersDescription: 'Wij werken voor nationale en internationale bedrijven, profit en non-profit. Wat ons bindt, is de noodzaak om complexe veranderingen door te maken waarbij IT, en vooral data, cruciaal is.',
