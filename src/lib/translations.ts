...
export interface TranslationContent {
  ...
  // customersTitlePart2: string; // Removed as per base
  // customersTitlePart3: string; // Removed as per base
...
export const translations: Translations = {
  nl: {
    ...
    customersTitlePart1: 'Onze klanten', // As per user's base file
    ...
    customersLinkedInClarification: "Onder voorgaande werkgevers is onder dienstverband werkzaamheden verricht voor diverse andere klanten. Voor meer informatie verwijs ik graag naar LinkedIn.", // New
    customersCTAChallenge: "Heeft u een uitdaging of project waarin ik kan meedenken of meewerken?", // New
    customersCTAPleasure: "Ik kom graag in contact voor vrijblijvende kennismaking.", // New
  ...
  en: {
    ...
    customersTitlePart1: 'Our clients', // As per user's base file
    customersDescription: "Tom de Bruijn has over 10 years of experience in the IT sector and has been working independently as DataSight since 2024. DataSight serves both national and international companies in both the profit and non-profit sectors. What connects us is the need to navigate complex transitions where IT, and data in particular, play a crucial role.",
    ...
    customersLinkedInClarification: "Under previous employers, work was performed for various other clients under an employment contract. For more information, please refer to LinkedIn.", // New
    customersCTAChallenge: "Do you have a challenge or project where I can contribute or collaborate?", // New
    customersCTAPleasure: "I would be happy to get in touch for a no-obligation introduction.", // New
