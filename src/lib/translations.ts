...
export interface TranslationContent {
  ...
  customersClarificationText: string; // Kept from base
  customersLinkedInClarification: string; // New key
  customersCTAChallenge: string; // New key
  customersCTAPleasure: string; // New key
...
export const translations: Translations = {
  nl: {
    ...
    customersTitlePart1: 'Vertrouwd door', // Reverted from "Ervaring opgedaan bij"
    // customersTitlePart2: 'door', // Removed
    // customersTitlePart3: 'bedrijven zoals', // Removed
    customersDescription: "Tom de Bruijn heeft meer than 10 jaar ervaring in de IT-sector en is sinds 2024 zelfstandig verder gegaan als DataSight. DataSight werkt voor zowel nationale als internationale bedrijven, zowel in de profit- als non-profitsector. Wat ons verbindt, is de behoefte om complexe veranderingen door te voeren, waarbij IT en vooral data cruciaal zijn.",
    customersClarificationText: "De onderstaande logo's vertegenwoordigen projecten die zijn gerealiseerd onder DataSight, projecten van Tom de Bruijn onder persoonlijke titel, en projecten voltooid tijdens zijn dienstverband bij zijn vorige werkgevers, Cinq ICT en Accenture.", // Kept from base
    customersLinkedInClarification: "Onder voorgaande werkgevers is onder dienstverband werkzaamheden verricht voor diverse andere klanten.\nVoor meer informatie verwijs ik graag naar LinkedIn.", // New
    customersCTAChallenge: "Heeft u een uitdaging of project waarin wij kunnen meedenken of meewerken? 🛠️", // New (emoticon added)
    customersCTAPleasure: "Wij komen graag in contact voor een vrijblijvende kennismaking.", // New
    ...
    service5DetailTitle: 'Trainingen & Workshops: Praktijkgerichte Trainingen & Workshops',
  ...
  en: {
    ...
    customersTitlePart1: 'Trusted by', // Reverted
    ...
    customersLinkedInClarification: "Under previous employers, work was performed for various other clients.\nFor more information, please refer to LinkedIn.", // New
    customersCTAChallenge: "Do you have a challenge or project where we can contribute or collaborate? 🛠️", // New (emoticon added)
    customersCTAPleasure: "We would be happy to get in touch for a no-obligation introduction.", // New
    ...
    service5DetailTitle: 'Trainings & Workshops: Practical Trainings & Workshops',
