...
export const translations: Translations = {
  nl: {
    ...
    service2DetailBullet4: 'Kostenbesparingsstrategieën door data-reductie pipelines en slimme datarouting.',
  ...
  en: {
    ...
    service2DetailBullet4: 'Cost-saving strategies through data reduction pipelines and smart data routing.',
    service2DetailBullet5: '',
