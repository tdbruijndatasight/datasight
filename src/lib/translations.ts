...
export const translations: Translations = {
  nl: {
    ...
    homeAboutMeP3: "Als gecertificeerd specialist in Splunk en Cribl is DataSight inzetbaar voor consultancy, projectwerkzaamheden, strategisch advies en op maat gemaakte trainingen op elk niveau. Op zoek naar een ervaren partner die écht betrokken is bij jouw succes? Laten we kennismaken.",
  ...
  en: {
    ...
    homeAboutMeP3: "Certified in Splunk and Cribl, DataSight provides consultancy, project work, strategic guidance, and tailored training at all levels. Looking for an experienced partner who’s genuinely invested in your success? Let’s connect.",
