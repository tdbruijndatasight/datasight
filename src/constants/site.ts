...
export const SITE_CONFIG = {
  ...
  companyLogos: [
    { name: 'Company A', src: 'https://placehold.co/150x75.png', dataAiHint: 'company logo' },
    { name: 'Company B', src: 'https://placehold.co/150x75.png', dataAiHint: 'company logo' },
    { name: 'Company C', src: 'https://placehold.co/150x75.png', dataAiHint: 'company logo' },
    { name: 'Company D', src: 'https://placehold.co/150x75.png', dataAiHint: 'company logo' },
    { name: 'Company E', src: 'https://placehold.co/150x75.png', dataAiHint: 'company logo' },
  ]
};
